  ...
  class Program
  {
    static void Main()
    {
      ...
      switch (Char.ToLower(ch))
      {
        ...
        case 'm':
          clientt = new Manager();
          clientt = (clientt as Manager).ReadFile(path);
          Console.WriteLine((clientt as Manager).PrintClientInfo());
          (clientt as Manager).patronymic = "Vasya";
          Console.WriteLine((clientt as Manager).patronymic);
          Console.WriteLine((clientt as Manager).PrintClientInfo());
          Main();
          break;
